...
namespace Vestras.StarCraft2.Grape.Core.Ast {
	public class GrapeMember: GrapeEntity {
		...
		protected virtual GrapeAccessExpression ToExpression(GrapeIdentifier identifier, GrapeAccessExpression next) {
			return GrapeMemberExpression.Create(identifier.Length == 1 ? GrapeAccessExpression.GrapeAccessExpressionType.Root : GrapeAccessExpression.GrapeAccessExpressionType.Field, identifier, next);
		}
