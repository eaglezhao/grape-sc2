    ...
    internal class GrapeIfStatementValidator : IAstNodeValidator {
        ...
        public bool ValidateNode(object obj) {
            if (Config.OutputErrors) {
                ...
                if (s != null) {
                    if (!typeCheckingUtils.DoesExpressionResolveToType(Config, s, s.Condition, "bool") && !typeCheckingUtils.DoesExpressionResolveToType(Config, s, s.Condition, "bool_base")) {
